...
FOR %%x IN ("C:\OpenServer\modules\php\PHP-5.4.7\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\OpenServer\modules\php\PHP-5.4.7\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\OpenServer\modules\php\PHP-5.4.7"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\OpenServer\modules\php\PHP-5.4.7\php.exe"
GOTO :INSTALLED
